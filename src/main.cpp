...
const string strMessageMagic = "JobsCoin Signed Message:\n";
...
int64_t GetProofOfWorkReward(int nHeight, int64_t nFees, uint256 prevHash)
{
	...
	if (nHeight <= 0)
        ...
        nSubsidy = 1000000 * COIN;	// Hold for develop and promotion
	else if (nHeight <= 9999)
        nSubsidy = 10 * COIN;      // Hold for develop and promotion
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "JobsCoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "JOBSCOIN started 23.09.2016";
        CTransaction txNew;
        txNew.nTime = 1474661234;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1474661234;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce   = !fTestNet ? 369207 : 369207;
...
//        hashGenesisBlock = block.GetHash();
        ...
        printf("block.nNonce = %u \n", block.nNonce);
        block.print();
        assert(block.hashMerkleRoot == uint256("0x4fcdd1655070eb9c75ebf0584f9353f2cec8d6b076bce5bb22f030b0829ff24a"));
    ...
    string strPubKey = "046d2c2b04cfb471597925c3ed59c1260d01b95fabe02c28695841b427eb1ce8386e99451b0221d35ed67cee5d9b5c3a755aef5d961fb15033869cf8534977db61";
