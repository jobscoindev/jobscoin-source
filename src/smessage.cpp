...
// Copyright (c) 2015 The JobsCoin developers
...
void ThreadSecureMsg(void* parg)
{
    ...
    RenameThread("jobscoin-smsg"); // Make this thread recognisable
...
void ThreadSecureMsgPow(void* parg)
{
    ...
    RenameThread("jobscoin-smsg-pow"); // Make this thread recognisable
